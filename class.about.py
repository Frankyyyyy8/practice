'''Class
  (1) What is class
  (2) ordinary vs static properteis
  (3) special methods
'''

print("===== What is class =====")
# class - bluprint for object creation!
...
person3 = Person("Frank", 28)

# ordianry state property
name = person1.name
...
class Car():
    # state
    descripton = "This class makes cars"
...
print(your_car)
response = your_car()  # look like function # CALL
